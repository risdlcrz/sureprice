...
@push('styles')
{{-- Extracted to resources/css/materials-form.css --}}
@vite('resources/css/materials-form.css')
@endpush

@push('scripts')
{{-- Extracted to resources/js/materials-form.js --}}
@vite('resources/js/materials-form.js')
@endpush
@endsection 