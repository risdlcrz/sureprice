...
<div class="container">
    ...
    <!-- Payment Modals - Moved outside the table -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add click event listeners to Pay buttons
    var payButtons = document.querySelectorAll('[data-bs-toggle="modal"]');
...
<style>
/* Ensure modals are properly hidden and don't interfere with table */
.modal {
    display: none;
}
.modal.show {
...
/* Prevent modal content from leaking into table */
.modal-content {
    position: relative;
    z-index: 1050;
}
