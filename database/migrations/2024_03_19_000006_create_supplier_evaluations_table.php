...
return new class extends Migration
{
    public function up()
    {
        Schema::create('supplier_evaluations', function (Blueprint $table) {
            ...
            $table->decimal('delivery_speed_score', 3, 2)->default(0);
            ...
            $table->decimal('cost_variance_score', 3, 2)->default(0);
            $table->decimal('cost_variance_ratio', 5, 2)->default(0);
            $table->decimal('sustainability_score', 3, 2)->default(0);
            $table->decimal('final_score', 3, 2)->default(0);
