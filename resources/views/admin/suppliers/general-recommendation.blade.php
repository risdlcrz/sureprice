...
@push('scripts')
<script src="{{ asset('resources/js/admin-suppliers-general-recommendation.js') }}"></script>
@endpush

@push('styles')
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">
<link href="{{ asset('resources/css/admin-suppliers-general-recommendation.css') }}" rel="stylesheet" />
@endpush 