    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('client.feedback.index') }}" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <p><strong>Submitted:</strong> {{ $feedback->submitted_at ? $feedback->submitted_at->format('M d, Y H:i') : 'Not submitted' }}</p>
                    ...
                    <!-- Ratings -->
                    <div class="mb-4">
                        <h5 class="text-primary mb-3">Your Ratings</h5>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        @if(!$feedback->submitted_at)
                            <a href="{{ route('client.feedback.edit', $feedback) }}" class="btn btn-warning">
