...
@push('styles')
{{-- Extracted to resources/css/quotations-form.css --}}
@vite('resources/css/quotations-form.css')
@endpush

@push('scripts')
{{-- Extracted to resources/js/quotations-form.js --}}
@vite('resources/js/quotations-form.js')
@endpush
@endsection 