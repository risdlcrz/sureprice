        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('resources/images/ppimage1.svg') }}" class="card-img-top" alt="Create Contract" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('resources/images/ppimage2.svg') }}" class="card-img-top" alt="View Contracts" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
