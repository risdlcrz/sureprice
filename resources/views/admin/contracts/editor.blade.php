...
<link href="{{ asset('resources/css/admin-contracts-editor.css') }}" rel="stylesheet" />
@endpush
...
<script>
window.contractEditorUserType = @json(auth()->user()->user_type ?? 'manager');
</script>
<script src="{{ asset('resources/js/admin-contracts-editor.js') }}"></script>
@endpush 