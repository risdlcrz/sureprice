    ...
    public function run(): void
    {
        ...
        $managerUsers = [
            ...
            [
                ...
                'username' => 'msantos_manager',
                'email' => 'msantos.manager@sureprice.com',
                'user_type' => 'manager',
                'role' => 'manager',
                'password' => Hash::make('password123'),
                'email_verified_at' => now(),
            ...
            [
                ...
                'username' => 'jreyes_manager',
                'email' => 'jreyes.manager@sureprice.com',
                'user_type' => 'manager',
                'role' => 'manager',
                'password' => Hash::make('password123'),
                'email_verified_at' => now(),
        ...
        // Create admin user for oversight
        $adminUser = [
            'name' => 'System Admin',
        ...
        // Ensure correct Manager One user
        $managerOne = [
            'name' => 'Manager One',
            'username' => 'manager1',
            'email' => 'manager1@example.com',
