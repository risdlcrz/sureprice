...
@section('content')
    ...
    <div class="container-fluid ">
        ...
        <!-- Removed Project Management section title as requested -->
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage5.jpg') }}" class="card-img-top" alt="Purchase Requests">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage4.jpg') }}" class="card-img-top" alt="Purchase Orders">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage8.jpg') }}" class="card-img-top" alt="Quotation Management">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage9.jpg') }}" class="card-img-top" alt="Materials Management">
                <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage10.png') }}" class="card-img-top" alt="Suppliers" style="object-fit:cover;width:100%;height:220px;">
                    <div class="card-body">
