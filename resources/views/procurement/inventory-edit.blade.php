...
<div class="container py-4">
    <h1 class="h3 mb-4 text-center" style="font-weight:700;color:#198754;letter-spacing:0.01em;">Edit Inventory Item</h1>
                ...
                <div class="card-body">
                    <form action="{{ route('procurement.inventory.update', $inventory) }}" method="POST">
                        ...
                        <div class="d-grid gap-2 mt-4">
                            <button type="submit" class="btn btn-primary btn-lg rounded-pill">Update Item</button>
...
@push('styles')
    @vite(['resources/css/procurement/inventory-edit.css'])
@endpush
@endsection 