        ...
        foreach ($suppliers as $supplier) {
            ...
            for ($i = 0; $i < rand(3, 5); $i++) {
                ...
                SupplierEvaluation::create([
                    ...
                    'engagement_score' => rand(70, 100) / 10,
                    'delivery_speed_score' => rand(60, 100) / 10,
                    'delivery_ontime_ratio' => rand(80, 100),
                    'performance_score' => rand(70, 100) / 10,
                    'quality_score' => rand(70, 100) / 10,
                    'defect_ratio' => rand(0, 10),
                    'cost_variance_score' => rand(70, 100) / 10,
                    'cost_variance_ratio' => rand(0, 10),
                    'sustainability_score' => rand(60, 100) / 10,
                    'final_score' => rand(70, 100) / 10,
