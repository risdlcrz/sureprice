...
@section('content')
    ...
    <div class="container-fluid ">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage1.jpg') }}" class="card-img-top" alt="Create Contract" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage2.jpg') }}" class="card-img-top" alt="View Contracts" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage3.jpg') }}" class="card-img-top" alt="Project Timeline" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage5.jpg') }}" class="card-img-top" alt="Purchase Requests" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage4.jpg') }}" class="card-img-top" alt="Purchase Orders" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage6.jpg') }}" class="card-img-top" alt="Inquiries" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="{{ asset('images/ppimage8.jpg') }}" class="card-img-top" alt="Quotation Management" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                    <div class="card-body">
