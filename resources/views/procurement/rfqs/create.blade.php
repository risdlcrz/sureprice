        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-header bg-white py-3">
                    <h4 class="card-title mb-0">Create Request for Quotation</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('procurement.rfqs.store') }}" method="POST" id="rfqForm">
                        @csrf
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('procurement.rfqs.index') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
...
@push('scripts')
<script>
let materialCount = 0; // Start at 0 as we'll inject the first one via JS or have it pre-filled
...
document.addEventListener('DOMContentLoaded', function() {
    // If there are old materials data, pre-fill them
    ...
    if (oldMaterials.length > 0) {
        ...
        // Otherwise, add one empty material field
        addMaterial();
    }
});
</script>
